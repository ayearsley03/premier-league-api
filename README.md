...
2. Set your API key as an environment variable: `FOOTBALL_API_KEY`
3. Run the Python script to extract data to CSV files
4. Import CSVs into Power BI
5. Build relationships between tables using team name columns

## Future Improvements

- Add player ratings by team
